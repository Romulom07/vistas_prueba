...
<body class="bg-gray-400">
  <div class="container mx-auto bg-white box-border border-gray-400 border-4 w-3/5 m-12  ">
    <form  method="post" action="{{route('marks.update', $mark)}}" class="">
      @method("PUT")
      @csrf
      <div class="p-4 m-1">
        <input type="text" name="name" value= "{{ $mark->name }}" placeholder="Ingrese nombre a editar"  class="h-9 m-1 w-80 bg-gray-300"> 
